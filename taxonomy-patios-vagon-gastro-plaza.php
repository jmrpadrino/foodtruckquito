...
?>
        ...
        <div id="hero" class="hero-header " style="background-image: url(<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>.jpg);">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img class="foodtruck-logo" src="<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>-logo.png" alt="Vagon Gastro Plaza" width="200">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="list-inline plaza-contacto">
                                <li><a href="https://www.facebook.com/vagongastroplaza/" target="_blank"><i class="zmdi zmdi-facebook zmdi-hc-2x"></i></a></li>
                                <li><a href="https://www.instagram.com/vagongastroplaza/" target="_blank"><i class="zmdi zmdi-instagram zmdi-hc-2x"></i></a></li>
                                <li><a href="tel:+593991856631"><i class="zmdi zmdi-phone zmdi-hc-2x"></i>
 099 185 6631</a></li>
                            </ul>
                        </div>
                    </div>
