...
?>
        ...
        <div id="hero" class="hero-header " style="background-image: url(<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>-hero.jpg);">
            <div class="hero-mask"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img class="foodtruck-logo" src="<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>-logo.png" alt="Quito Food Festival La Gasca" width="200">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="list-inline plaza-contacto">
                                <li><a href="https://www.facebook.com/QuitoFoodFestival/" target="_blank"><i class="zmdi zmdi-facebook zmdi-hc-2x"></i></a></li>
                                <li><a href="https://www.instagram.com/quitofoodfestival/" target="_blank"><i class="zmdi zmdi-instagram zmdi-hc-2x"></i></a></li>
                                <li><a href="tel:+593998202153"><i class="zmdi zmdi-phone zmdi-hc-2x"></i>
 099 820 2153</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <script>
            function initMap() {
                var myLatLng = {lat: -0.19656798426001, lng: -78.502056598663};
