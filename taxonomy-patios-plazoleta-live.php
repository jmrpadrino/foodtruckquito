...
?>
        ...
        <div id="hero" class="hero-header " style="background-image: url(<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>-19.jpg);">
            <div class="hero-mask"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img class="foodtruck-logo" src="<?php echo get_template_directory_uri(); ?>/plaza/<?php echo $termino->slug; ?>/<?php echo $termino->slug; ?>-logo.png" alt="Plazoleta Live Logo" width="200">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="list-inline plaza-contacto">
                                <li><a href="https://www.facebook.com/uioplazoleta/" target="_blank"><i class="zmdi zmdi-facebook zmdi-hc-2x"></i></a></li>
                                <li><a href="https://www.instagram.com/laplazoletauio/" target="_blank"><i class="zmdi zmdi-instagram zmdi-hc-2x"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
        ...
        <script>
            function initMap() {
                var myLatLng = {lat: -0.1809097, lng: -78.4944724};
